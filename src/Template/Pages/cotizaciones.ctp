				...
				<div class="pi-section pi-section-md pi-titlebar pi-titlebar-breadcrumb-right pi-titlebar-small">
					...
					<div class="pi-breadcrumb">Seccion:
						<ul>
							...
							<li><?=  $this->Html->link( 'Solicitar /Presupuesto', 'pages/cotizaciones',['class' => '']); ?>
							</li>
						</ul>
					</div>
				</div>
					...
					<form role="form" action="/proyecto/Cotizaciones/registroCotizacion" method="POST">
						...
						<div class="form-group">
							<div class="pi-input-with-icon">
								...
								<input type="text" name="users" class="form-control" id="exampleInputName-1" placeholder="Nombre y Apellido">
							</div>
						</div>
						<!-- End first name form -->
						...
						<div class="form-group">
							<div class="pi-input-with-icon">
								...
								<input type="email" name="correo" class="form-control" id="exampleInputEmail-1" placeholder="Correo Electronico">
							</div>
						</div>
						<!-- End email form -->
						...
						<div class="form-group">
							<div class="pi-input-with-icon">
								...
								<input type="text" name="empresa" class="form-control" id="exampleInputPassword-1" placeholder="Empresa">
							</div>
						</div>
						<!-- empresa -->
